    ...
    <div className='lg:px-1 py-10'>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          <p onClick={() => speciality === 'Emergency Department' ? navigate('/doctors') : navigate('/doctors/Emergency Department')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Emergency Department' ? 'bg-red-50 text-red-700 ' : ''}`}>Emergency Department</p>
        </div>
        <div className='w-full grid grid-cols-auto gap-4 gap-y-6 justify-center'>
