...
const DoctorContextProvider = (props) => {
    ...
    const getEmergencyCases = async () => {
        try {
            const { data } = await axios.get(backendUrl + '/api/doctor/emergency-cases', { headers: { dToken } })
            if (data.success) {
    ...
    const getServiceBookings = async () => {
        try {
            const { data } = await axios.get(backendUrl + '/api/doctor/service-bookings', { headers: { dToken } })
            if (data.success) {
    ...
    const value = {
        ...
        emergencyCases, getEmergencyCases,
        serviceBookings, getServiceBookings,
