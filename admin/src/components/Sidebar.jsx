  ...
  return (
    <div className='min-h-screen bg-white border-r'>
      {aToken && <ul className='text-[#515151] mt-5'>
        ...
        <NavLink to={'/services'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <img className={iconClass} src={assets.list_icon} alt='' />
          <p className='hidden md:block'>Services</p>
        </NavLink>
        <NavLink to={'/service-bookings'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <img className={iconClass} src={assets.appointments_icon} alt='' />
          <p className='hidden md:block'>Service Bookings</p>
        </NavLink>
        <NavLink to={'/emergency-booking'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-red-50 border-r-4 border-red-600' : ''}`}>
          <img className={iconClass} src={assets.appointment_icon} alt='' />
          <p className='hidden md:block text-red-600'>Emergency Booking</p>
        </NavLink>
        <NavLink to={'/emergency-cases'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-red-50 border-r-4 border-red-600' : ''}`}>
          <img className={iconClass} src={assets.patients_icon} alt='' />
          <p className='hidden md:block text-red-600'>Emergency Cases</p>
        </NavLink>
      </ul>}
